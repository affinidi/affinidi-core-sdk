import {VCV1Proof, VCV1Type, VPV1Type} from '@affinidi/vc-common'

const presentationWithSubmission = {
  '@context': [
    'https://www.w3.org/2018/credentials/v1',
    'https://identity.foundation/presentation-exchange/submission/v1',
  ],
  type: ['VerifiablePresentation', 'PresentationSubmission'] as VPV1Type,
  holder: {
    id: 'did:elem:EiBPGxTXuoX6QSajxrSg5CusYoCw9uMGiV4xTq0iaNSN2Q;elem:initial-state=',
  },
  ...
  verifiableCredential: [
    {
      ...
      type: ['VerifiableCredential', 'ContentLike'] as VCV1Type,
      holder: {
        id:
