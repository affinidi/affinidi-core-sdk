...
* [Interface](#interface)
  ...
  - [Verifier](#verifier)
    - [Initiate Verifiable Presentation request (credential share request)](#initiate-credential-share-request)
    - [Validate Verifiable Presentation (Holder Response on Share Request)](#validate-holder-response-on-share-request)
  ...
  - [Wallet](#wallet)
    ...
    - [Create Verifiable Presentation (Response on credential share request)](#create-response-on-credential-share-request)
