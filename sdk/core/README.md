...
```
`encryptedSeed`- randomly auto generated by [Generate seed](#Generate seed) [more detail exaple](#Initialize from seed) material that used as input for a private key generation. Generated as a part of [register](#Create DID) / [signUp](#Sign up) process and stored as encrypted value in protected vault.
