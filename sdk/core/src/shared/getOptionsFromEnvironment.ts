  ...
  switch (env) {
    ...
    case 'dev':
      return {
        ...
        bloomVaultUrl: options.vaultUrl || DEV_BLOOM_VAULT_URL,
    ...
    case 'prod':
      return {
        ...
        bloomVaultUrl: options.vaultUrl || PROD_BLOOM_VAULT_URL,
    ...
    case 'staging':
      return {
        ...
        bloomVaultUrl: options.vaultUrl || STAGING_BLOOM_VAULT_URL,
