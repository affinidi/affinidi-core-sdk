...
export const DEV_BLOOM_VAULT_URL = 'https://bloom-vault.dev.affinity-project.org'
export const DEV_AFFINIDI_VAULT_URL = 'https://affinidi-vault.dev.affinity-project.org'
...
export const STAGING_BLOOM_VAULT_URL = 'https://bloom-vault.staging.affinity-project.org'
export const STAGING_AFFINIDI_VAULT_URL = 'https://affinidi-vault.staging.affinity-project.org'
...
export const PROD_BLOOM_VAULT_URL = 'https://bloom-vault.prod.affinity-project.org'
export const PROD_AFFINIDI_VAULT_URL = 'https://affinidi-vault.prod.affinity-project.org'
