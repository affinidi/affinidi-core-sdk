...
export const DEV_COGNITO_CLIENT_ID = '1a8vhef3bnep5lafunqncf5opv'
export const DEV_COGNITO_USER_POOL_ID = 'ap-southeast-1_lCQNNgx6b'
...
export const DEV_KEY_STORAGE_URL = 'https://affinity-wallet-backend.dev.affinity-project.org'
export const DEV_VAULT_URL = 'https://bloom-vault.dev.affinity-project.org'
...
export const STAGING_COGNITO_CLIENT_ID = '640chorik9mgeqenmsbt08ks51'
export const STAGING_COGNITO_USER_POOL_ID = 'ap-southeast-1_y2jlNAYfX'
...
export const STAGING_KEY_STORAGE_URL = 'https://affinity-wallet-backend.staging.affinity-project.org'
export const STAGING_VAULT_URL = 'https://bloom-vault.staging.affinity-project.org'
...
export const PROD_COGNITO_CLIENT_ID = '3bqoujbhqqkqpp7bbavvsl5rs6'
export const PROD_COGNITO_USER_POOL_ID = 'ap-southeast-1_VDuBDCmYz'
...
export const PROD_KEY_STORAGE_URL = 'https://affinity-wallet-backend.prod.affinity-project.org'
export const PROD_VAULT_URL = 'https://bloom-vault.prod.affinity-project.org'
