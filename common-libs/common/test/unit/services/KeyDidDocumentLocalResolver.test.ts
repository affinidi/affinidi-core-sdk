import {
  resolveDidKeyLocal,
  resolveKeyDIDWithParams,
} from '../../../src/services/DidDocumentService/KeyDidDocumentLocalResolver'
  ...
  it('should resolve did key', async () => {
    ...
    expect(resolved).to.be.deep.eq({
      ...
      publicKey: [
        {
          id:
            'did:key:zQ3shayiAFLT3zyKP4E2iN3vWi7FrkQkP1wZdfhpZvqmERPXd#zQ3shayiAFLT3zyKP4E2iN3vWi7FrkQkP1wZdfhpZvqmERPXd',
  ...
  it('should resolve did key as json format (JWK)', async () => {
    ...
    expect(resolved).to.be.deep.eq({
      ...
      publicKey: [
        {
          id:
            'did:key:zQ3shsN61ycuj7Q9b4h2YAieDuBGmSqTQmVqASdZm9V3uqGZh#zQ3shsN61ycuj7Q9b4h2YAieDuBGmSqTQmVqASdZm9V3uqGZh',
          type: 'JsonWebKey2020',
